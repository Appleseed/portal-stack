...
- `docker inspect -f "{{ .NetworkSettings.Networks.portalstack_default.IPAddress }}" portalstack_db-mssql-express-2016_1`
- `docker inspect -f "{{ .NetworkSettings.Networks.portalstack_default.IPAddress }}" portalstack_web-appleseed-portal_1`
